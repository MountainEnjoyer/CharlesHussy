    ...
    return (
        <>
            <ul className='relative text-xl pt-[150px] mt-[10px] w-[80%] pl-[20%] text-wrap'>
                ...
                <li>Hüssy C.H., 2021. Une Nouvelle Alliance. Nourrir une espérance pour l’après-effondrement. Éd. L’Harmattan.</li><br/>
                <li>Hüssy C.H., 2021. Un Christ vert. Un Dieu amoureux de sa Création. Éd. L’Harmattan.</li><br/>
                <li>Hüssy C.H., 2024, L’attente. En quête du projet de Dieu. Éd. L’Harmattan.</li><br/>
                <li>Hüssy C.H., 2026, Le mythe de Kairos. Changer ou disparaître. Éd. Saint-Augustin.</li><br/>
            </ul>
        </>
    )
}
